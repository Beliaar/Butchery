...
public interface IButcherable {
	...
	/**
	 * The primary output. This is the ItemStack that is visible in the
	 * crafting gui.
	 * 
	...
	/**
	 * The secondary outputs. These will be the ItemStacks that will be put
	 * in the players inventory, or dropped at the players position if
	 * the inventory is full.
	 * 
	 * @return An Array of ItemStack objects that will be created as
	 * secondary outputs.
	 */
